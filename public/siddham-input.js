...
import { devanagari2ascii } from "./devanagari.js"
function update() {
    ...
    const text = devanagari2ascii(latin2ascii(ascii2symbol(in_text.value), { inputMethod: /** @type {"ISO15919" | "KH"} */ option_input_method.value }))
